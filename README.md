...
```json
{
  ...
  "hotspots": [
    { "from": "MeuProjeto/sala1.jpg", "to": "MeuProjeto/sala2.jpg", "text": "Ir para Sala 2", "pitch": 0, "yaw": 90 }
  ],
  "topViewHotspots": [
    { "left": "30%", "top": "40%", "target": "MeuProjeto/sala1.jpg", "title": "Sala 1" }
  ]
}
```
...
3. Navegue pelas salas usando:
   - Hotspots no modo 360º (pontos clicáveis)
   - Menu de salas (botão no canto inferior direito)
   - Vista de cima (botão "Top View")
...
- **Partilha**: Copiar link da sala atual
- **Responsivo**: Funciona em desktop e mobile

## Tecnologias Utilizadas

- HTML5, CSS3, JavaScript (Vanilla)
- Pannellum.js para visualização 360º
...
2. **Escalabilidade**: Fácil adição de novos projetos
